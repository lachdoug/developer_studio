module Repo
  class App
    class Blueprint
      module Conform
        class BetaBlueprintToSchema1_0
          ...
          def metadata
            {
              blueprint: {
                version: {
                  ...
                  level: r(:software, :release_level).to_s.sub('Release candidate', 'rc'),
          ...
          def base
            {
              ...
              framework_port_override: r(:software, :framework_port_override).to_i,
